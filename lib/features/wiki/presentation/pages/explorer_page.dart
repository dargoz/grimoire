              ...
              Container(
                ...
                child: DropdownSearch<String>(
                  ...
                  items: (filter, loadProps) =>
                      _fileController.getBranchList(filter),
                  ...
                  onSelected: (value) async {
                    if (value != null) {
                      ...
                      var encryptedBox = await HiveDataSource().openBox(
                        'projectBox',
                      );
        ...
        if (!isPortrait)
          panelContainer(
            ...
            childWidget: Column(
              children: [
                ref
                    .watch(fileTreeStateNotifierProvider)
                    .when(
                      data: (model) {
                        ...
                        return Expanded(
                          child: FileTreeWidget(
                            ...
                            onTap: (fileTreeModel) {
                              var path = fileTreeModel.path.replaceAll(
                                '/',
                                '%2F',
                              );
